...
// @version      7.3.2
// @description  Stable version of RLM V7.3.2 with multi-language support and server-specific building IDs
            ...
            details.onload = function(response) {
                try {
                    ...
                    if (Array.isArray(data)) {
                        RLM_POI_TYPES.forEach(function(extra) {
                    ...
                    console.warn('RLM V7 Stable Loader: could not inject RLM tags into poi-types', e);
                }
                origOnload(response);
            };
        }
